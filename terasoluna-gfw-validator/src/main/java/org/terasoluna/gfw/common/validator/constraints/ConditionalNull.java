...
import org.terasoluna.gfw.common.validator.constraintvalidators.ConditionalNullValidator;
...
public @interface ConditionalNull {
    ...
    String message() default "{org.terasoluna.gfw.common.validator.constraints.ConditionalNull.message}";
    ...
    CompositionType compositionType() default CompositionType.AND;
