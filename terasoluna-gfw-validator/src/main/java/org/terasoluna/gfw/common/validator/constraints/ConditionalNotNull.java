...
import org.terasoluna.gfw.common.validator.constraintvalidators.ConditionalNotNullValidator;
...
public @interface ConditionalNotNull {
    ...
    String message() default "{org.terasoluna.gfw.common.validator.constraints.ConditionalNotNull.message}";
